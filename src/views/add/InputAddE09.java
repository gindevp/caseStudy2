...
public class InputAddE09 {
    static Scanner scanner= new Scanner(System.in);
    static Scanner scanner1= new Scanner(System.in);

    public static void choiceE09(List studentList,String pathFile) {
        ...
        System.out.println("Mời nhập điểm Vẽ(0->10):");
        int toan= scanner.nextInt();
        System.out.println("Mời nhập điểm Địa(0->10):");
        int ly= scanner.nextInt();
        System.out.println("Mời nhập điểm Sử(0->10):");
        int hoa= scanner.nextInt();
        Student students= new StudentE09(id,name,className,age,sexReal,date,phone,note,toan,ly,hoa);
